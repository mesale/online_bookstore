...
=======
                        className={`w-4 h-4 rounded-lg border-2 flex items-center justify-center transition-colors ${
                          condition === c
                            ? "border-primary bg-primary"
...
=======
                          condition === c ? "text-primary font-semibold" : "text-on-surface"
>>>>>>> 9e3f8ba (feat: replace legacy bookstore-login with new online-bookstore frontend and update backend security and service configurations.)
                        }`}
                      >
                        {c}
...
=======
                          category === cat ? "text-primary font-semibold" : "text-on-surface"
>>>>>>> 9e3f8ba (feat: replace legacy bookstore-login with new online-bookstore frontend and update backend security and service configurations.)
                        }`}
                      >
                        {cat}
